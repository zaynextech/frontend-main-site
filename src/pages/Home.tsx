...
import TechStack from "../components/home/TechStackLeft/TechStack";
...
import BrandRatingsCards from "@/components/home/BrandRatingsCards";
...
const Home = () => {
  ...
  return (
    ...
    <main className="relative flex min-h-screen flex-col bg-[#030303] text-zinc-200 antialiased">
      ...
      {/* Renders the non-intrusive scrolling hint engine globally across viewports */}
      <ScrollReminder />
